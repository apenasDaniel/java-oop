...
// tabuleiroJogo = gameBoard
// scan = scanner
// placePiece = lugarMarcado
// rand = aleatorio
...
public class JogoDaVelha {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			while(posicoesJogadores.contains(posicoesJogadores) || posicoesMaquina.contains(posicoesJogadores)) {
				System.out.println("Posição já marcada. Escolha outra posição");
				posicoesJogadores = scan.nextInt();
			}
